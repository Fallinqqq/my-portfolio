/**
 * ─────────────────────────────────────────────────────
 *  PROJECT PAGE: Restaurant Ordering System
 *
...
// ── INFO ─────────────────────────────────────────────
const title       = 'Restaurant Ordering System'
const role        = 'UI Designer & Developer'
const year        = '2022'
const description = 'A full-stack system for restaurants to manage orders, inventory, and customer relationships — with both customer-facing and administrative interfaces.'
const tools       = ['React', 'Node.js', 'Docker']
const liveLink    = ''
const githubLink  = 'https://github.com/gracefoster/restaurant-system'

// ── IMAGES ───────────────────────────────────────────
const images = [
  {
    src: '/images/restaurant-system-hero.png',   // ← replace with your image
    alt: 'Restaurant Ordering System – overview',
    caption: '',
  },
]
